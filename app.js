...
.pauseFor(1000)
.deleteChars(6)
.typeString('<span style="color: #647687;"> React</span> !')
.pauseFor(1000)
.deleteChars(7)
.typeString('<span style="color: #bc8f8f;"> JavaScript</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #8b4513;"> NodeJS</span> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #806972;"> Django</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #b22222;"> web designer</span> !')
.pauseFor(1000)
.deleteChars(14)
.typeString('<span style="color: #FF7c7c;"> et formatrice IT</span> !')
.start()
